...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="shumuyueduList2.do" name="myform" method="post">
    ...
    <td align='center'>读者</td>
                            ...
                            <td align="center" bgcolor="#ebf0f7" width="150px"> 开读时间 </td>
    ...
    <td>${u.duzhe}</td>
		 ...
		 <c:if test="${page.page>1}">
              <a href="shumuyueduList2.do?page=1" >首页</a>
             <a href="shumuyueduList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="shumuyueduList2.do?page=${page.page+1 }">下一页</a>
			<a href="shumuyueduList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
