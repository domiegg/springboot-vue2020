...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateShumuxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改书目信息<input type="hidden" name="id" value="${shumuxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.shumubianhao.value='${shumuxinxi.shumubianhao}';</script>	<script language="javascript">document.form1.shumumingcheng.value='${shumuxinxi.shumumingcheng}';</script>	<script language="javascript">document.form1.shumuleibie.value='${shumuxinxi.shumuleibie}';</script>	<script language="javascript">document.form1.jiage.value='${shumuxinxi.jiage}';</script>	<script language="javascript">document.form1.xiaoliang.value='${shumuxinxi.xiaoliang}';</script>	<script language="javascript">document.form1.chubanshe.value='${shumuxinxi.chubanshe}';</script>	<script language="javascript">document.form1.zuozhe.value='${shumuxinxi.zuozhe}';</script>	<script language="javascript">document.form1.fengmian.value='${shumuxinxi.fengmian}';</script>	<script language="javascript">document.form1.shumujianjie.value='${shumuxinxi.shumujianjie}';</script>	
					 </table>
			</form>
   </body>
</html>
