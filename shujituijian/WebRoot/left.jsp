...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="custom">
			<dt onClick="changeImage()">书目类别管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="shumuleibie_add.jsp" target="rightFrame">书目类别添加</a></dd>
			<dd><a href="shumuleibieList.do" target="rightFrame">书目类别查询</a></dd>

		</dl>
	
		<dl class="channel">
			<dt onClick="changeImage()">书目信息管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="shumuxinxi_add.jsp" target="rightFrame">书目信息添加</a></dd>
			<dd><a href="shumuxinxiList.do" target="rightFrame">书目信息查询</a></dd>
		</dl>
